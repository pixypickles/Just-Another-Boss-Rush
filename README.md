...
## v104
- 神鉄球サッカーの竜騎士Aを移動しない中距離の突きへ調整。
- 竜騎士Cを突き線のない円形ドラゴンスイープへ修正。


## v107
- 神鉄球サッカーの白狐忍B「氷柱壁」と気功師B「気功壁」を、ゴールラインと平行な縦方向に統一。


## v108
- 神鉄球サッカーのモンク・武神Aパンチの発生位置を顔の下付近へ上げました。
- 武神の左右表示を修正し、攻撃方向とキャラクターの向きを一致させました。
