...
const AWAKEN_UNLOCK_KEY='jabrAwakeningUnlockedV1',MONK_UNLOCK_KEY='jabrMonkUnlockedV1',HIGHPRIEST_UNLOCK_KEY='jabrHighPriestUnlockedV2',MAGICBLADE_UNLOCK_KEY='jabrMagicbladeUnlockedV1',RUNEMAGE_UNLOCK_KEY='jabrRunemageUnlockedV1',NINJA_UNLOCK_KEY='jabrNinjaUnlockedV1',DRAGONKNIGHT_UNLOCK_KEY='jabrDragonKnightUnlockedV1',DRACULA_UNLOCK_KEY='jabrPlayableDraculaUnlockedV1',MIMIC_UNLOCK_KEY='jabrMimicUnlockedV1';
...
function validateHeroSkills(hero){
 ...
 const extra={runemage:['placeRune'],dragonknight:['dragonThrust','dragonCharge','dragonSweep'],qigong:['fireQigongA','fireQigongC','deployQigongWall'],dracula:['bloodLaser','summonBats']}[hero.type]||[];
...
class Hero{
 ...
 draw(i){
  ...
  const sw=this.type==='mimic'?142:this.type==='dracula'?158:this.type==='monk'?142:this.type==='magicblade'?174:this.type==='ninja'?135:this.type==='highpriest'?126:this.type==='runemage'?128:this.type==='qigong'?138:this.type==='dragonknight'?168:112,sh=this.type==='mimic'?160:this.type==='dracula'?176:this.type==='monk'?160:this.type==='magicblade'?150:this.type==='ninja'?126:this.type==='highpriest'?149:this.type==='runemage'?150:this.type==='qigong'?156:this.type==='dragonknight'?166:126;if(this.hidden){ctx.globalAlpha=.18}
