...
class Hero{
 ...
 soloSkill(){
  ...
  if(this.type==='knight'){
   ...
   this.soloCd=14;this.qigongFocus=10;this.inv=.45;burst(this.x,this.y,'#ffcf5c',58,480);notice('気脈解放！ 10秒間 A即最大／気功壁強化／Cチャージ5倍！','#ffe39a',1200)
